...
public class JOptionPaneArrays {
    ...
    public String[][] convert(int[][] source) {
        ...
        for (int k = 0; k < target.length; k++) {
            target[k] = new String[source[k].length];
            for (int j = 0; j < target[k].length; j++) {
                target[k][j] = String.valueOf(source[k][j]);
            }
    ...
    // Arrays 1D
    public static JPanel createJPanel(Component parentComponnet, char[] matrix,
            String message) {
    ...
    public static JPanel createJPanel(Component parentComponnet, int[] matrix,
            String message, boolean showText) {
        GridLayout gridLay = null;
        JLabel label = null;
        JPanel panel = null;
    ...
    public static JPanel createJPanel(Component parentComponnet, float[] matrix,
            String message) {
        GridLayout gridLay = null;
        JLabel label = null;
        JPanel panel = null;
    ...
    public static JPanel createJPanel(Component parentComponnet, String[] matrix,
            String message) {
        GridLayout gridLay = null;
        JLabel label = null;
        JPanel panel = null;
    ...
    public static JPanel createJPanel(Component parentComponnet,
            int[][] matrix,
            String message, boolean showAsColors) {
    ...
    public static void showColorArray2D(Component parentComponent,
            int[][] matrix) {
